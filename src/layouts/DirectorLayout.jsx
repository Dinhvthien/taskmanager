...
const DirectorLayout = () => {
  ...
  const navigation = [
    ...
    { name: 'Công việc', href: '/director/tasks', icon: ClipboardDocumentListIcon },
    ...
    { name: 'Thông tin công ty', href: '/director/company', icon: BuildingOffice2Icon },
    { name: 'Báo cáo', href: '/director/reports', icon: ChartBarIcon },
  ]
