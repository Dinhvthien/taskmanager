...
const UserLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-2 sm:px-4 py-4 sm:py-6 space-y-1 sm:space-y-2 overflow-y-auto">
            {navigation.map((item) => {
              ...
              return (
                ...
                >
                  <Icon className={`h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 ${active ? 'text-purple-600' : 'text-gray-400'}`} />
            ...
            <div>
              ...
              >
                <div className="flex items-center space-x-2 sm:space-x-3">
                  <CalendarDaysIcon className={`h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0 ${isWorkScheduleActive ? 'text-purple-600' : 'text-gray-400'}`} />
          ...
          {!sidebarCollapsed && (
            <div className="p-2 sm:p-4 border-t border-gray-200">
              <div className="flex items-center justify-between px-3 sm:px-4 py-2 bg-purple-50 rounded-lg">
                <div className="flex items-center space-x-2">
                  <span className="text-sm font-medium text-gray-700">Điểm:</span>
                  {scoreLoading ? (
                    <span className="text-sm text-gray-500">Đang tải...</span>
                  ) : averageScore !== null && averageScore !== undefined ? (
                    <span className="text-sm font-bold text-purple-600">{averageScore.toFixed(2)}</span>
                  ) : (
                ...
                <button
                  ...
                  className="text-xs text-purple-600 hover:text-purple-700 hover:underline flex items-center space-x-1"
                >
      ...
      {/* Main content */}
      <div className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-0' : 'lg:ml-0'}`}>
        {/* Top header */}
          ...
          <div className="flex items-center justify-between h-14 sm:h-16 px-3 sm:px-4 md:px-6">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
              ...
              <div className="relative">
                ...
                >
                  <Avatar size={10} className="border-2 border-purple-600" />
                </button>
                {avatarMenuOpen && (
                  <>
                    <div 
